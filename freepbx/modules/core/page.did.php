...
<div class="rnav">
<ul>
	<?php /*?><li><a <?php echo ($extdisplay=='' ? 'class="current"':'') ?> href="<?php echo $display_add?>"><?php echo _("Add Incoming Route")?></a></li><?php */?>
	<li><a <?php echo ($extdisplay=='' ? 'class="current"':'') ?> href="<?php echo $display_add?>"><?php echo _("Add Incoming Number")?></a></li>
...
<?php
	if ($action == 'delIncoming') {
		...
		echo '<br><h3>Number '.$extdisplay.' '._("deleted").'!</h3><br><br><br><br><br><br><br><br>';
	} else {
?>
<?php
    if ($extdisplay) {
      ...
      if (is_array($ininfo) && !empty($ininfo)) {
        ...
        $delete_url = true;
?>
		<?php /*?><h2><?php echo _("Route")?>: <?php echo !empty($description)?$description:$extdisplay; ?></h2><?php */?>
		<h2><?php echo _("Number")?>: <?php echo !empty($description)?$description:$extdisplay; ?></h2>
<?php
      } else {
        ...
        $extdisplay = '';
?>
    <?php /*?><h2><?php echo _("Add Incoming Route")?></h2><?php */?>
    <h2><?php echo _("Add Incoming Number")?></h2>
<?php
      }
    ...
    if ($delete_url) {
		  ...
		  $tlabel = sprintf(_("Delete Number %s"),!empty($description)?$description:$extdisplay);
...
?>
		...
		<table>
		<?php /*?><tr><td colspan="2"><h5><?php echo ($extdisplay ? _('Edit Incoming Route') : _('Add Incoming Route')) ?><hr></h5></td></tr><?php */?>
		<tr><td colspan="2"><h5><?php echo ($extdisplay ? _('Edit Incoming Number') : _('Add Incoming Number')) ?><hr></h5></td></tr>
		<tr>
