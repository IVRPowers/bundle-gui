...
require_once(dirname(__FILE__) . "/lib/jpgraph_lib/jpgraph.php");
require_once(dirname(__FILE__) . "/lib/jpgraph_lib/jpgraph_pie.php");
require_once(dirname(__FILE__) . "/lib/jpgraph_lib/jpgraph_pie3d.php");
