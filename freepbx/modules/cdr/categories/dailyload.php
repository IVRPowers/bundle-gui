...
<div id="maincdr">
	<table class="cdr">
		<tr>
			<td>
				<form method="post" action="config.php?display=cdr&view=dailyload" enctype="application/x-www-form-urlencoded">
				<INPUT TYPE="hidden" NAME="posted" value="1">
				<fieldset>
					<legend class="title"><?php echo _("Daily Load")?></legend>
...
<br/>
<div id="maincdr">
	<table id="hourdetail" class="cdr">
		<tr>
			<td>
				<FORM METHOD=POST ACTION="modules/cdr/categories/graph_hourdetail.php?posted=<?php echo $posted?>&min_call=<?php echo $min_call?>&fromstatsday_sday=<?php echo $fromstatsday_sday?>&days_compare=<?php echo $days_compare?>&fromstatsmonth_sday=<?php echo $fromstatsmonth_sday?>&dsttype=<?php echo $dsttype?>&sourcetype=<?php echo $sourcetype?>&clidtype=<?php echo $clidtype?>&channel=<?php echo $channel?>&resulttype=<?php echo $resulttype?>&dst=<?php echo $dst?>&src=<?php echo $src?>&clid=<?php echo $clid?>&userfieldtype=<?php echo $userfieldtype?>&userfield=<?php echo $userfield?>&accountcodetype=<?php echo $accountcodetype?>&accountcode=<?php echo $accountcode?>" target="superframe">
				<fieldset>
					<legend class="title"><?php echo _("Select the hour interval to see the details")?></legend>
					<table>
						<tr>
							<td style="width: 150px; padding-top: 3px;">&nbsp;&nbsp;Hour Interval: </td>
							<td style="width: 250px; padding-top: 3px;">
								<select name="hourinterval" style="width: 170px">
								<?php 
									for ($i=0;$i<=23;$i++){							
						...
						<tr>
							<td style="width: 150px; padding-top: 3px;">&nbsp;&nbsp;Type Graph:</td>
							<td style="width: 250px; padding-top: 3px;">
								<select name="typegraph" style="width: 170px">
									<option value="fluctuation"> FLUCTUATION GRAPH</option> 
									<option value="watch-call" selected> WATCH CALLS GRAPH</option>
								</select>
							</td>
						</tr>
						<tr>
							<td style="width: 150px; padding-top: 3px;"></td>
							<td style="width: 250px; padding-top: 3px;" align="center"><input type="submit" value="Search"></td>
						</tr>
					</table>
				</fieldset>
				</FORM>
