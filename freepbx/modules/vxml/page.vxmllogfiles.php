...
$loglist = array(
			'client.log.apache' => trim(shell_exec("grep 'client.log.apache' /etc/openvxi/client.cfg | awk '{ print $3 }'")),
			'client.log.filename' => trim(shell_exec("grep 'client.log.filename' /etc/openvxi/client.cfg | awk '{ print $3 }'")),
			'client.log.voicexml' => trim(shell_exec("grep 'client.log.voicexml' /etc/openvxi/client.cfg | awk '{ print $3 }'"))
			);
